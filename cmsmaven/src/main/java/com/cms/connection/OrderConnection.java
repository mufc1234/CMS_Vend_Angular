...
public class OrderConnection {
	...
	public ArrayList<CombinedClass> ViewOrder(int b)
	{
		...
		try {
		  ...
		  if(b==3401)
			...
			String sql = "select u.user_name,o.order_id,o.user_id,o.quantity,o.Tprice,m.item_name from employee u inner join `order` o on u.user_id = o.user_id inner join menu_item m on m.item_id = o.item_id where o.status =1 and o.Vendor_id = ? ;";
